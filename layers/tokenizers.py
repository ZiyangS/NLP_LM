...
class Tokenizer(object):
    def __init__(
        ...
        do_lower_case=True, # Whether to convert the text to lowercase during tokenization
        do_basic_tokenize=True, # Whether to perform basic tokenization before applying wordpiece tokenization
        unk_token="[UNK]", # Special tokens used for unknown tokens
        sep_token="[SEP]", # Sentence separation token. Given one sentence, use [SEP] in the end; given two sentences, use [SEP] in the end of two sentences
        pad_token="[PAD]",
        cls_token="[CLS]",
        mask_token="[MASK]"
    ):
